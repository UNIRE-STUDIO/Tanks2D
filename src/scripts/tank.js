...
export default class Tank
{
    constructor(config, currentMap, spawnBullet)
    {
        ...
        this.image_up.src = "/sprites/Tank_Up.png";
        this.image_down = new Image();
        this.image_down.src = "/sprites/Tank_Down.png";
        this.image_right = new Image();
        this.image_right.src = "/sprites/Tank_Right.png";
        this.image_left = new Image();
        this.image_left.src = "/sprites/Tank_Left.png";
