...
export default class Bullet
{
    constructor(pos, dir, config, currentMap, remove, id)
    {
        ...
        this.image_up.src = "/src/sprites/Bullet_Up.png";
        this.image_down = new Image();
        this.image_down.src = "/src/sprites/Bullet_Down.png";
        this.image_right = new Image();
        this.image_right.src = "/src/sprites/Bullet_Right.png";
        this.image_left = new Image();
        this.image_left.src = "/src/sprites/Bullet_Left.png";
